...
describe('Logger', () => {
  ...
  describe('#enableRollbar', () => {
    it('should initialize and configure Rollbar', () => {
      let RollbarFake = sinon.stub()
      RollbarFake.configure = sinon.stub()

      logger.__set__('Rollbar', RollbarFake)

      logger.enableRollbar()

      let rollbar = logger.__get__('rollbar')
      RollbarFake.configure.should.have.been.called
      rollbar.should.deep.equal({})
    })
  })
  ...
  describe('#info', () => {
    ...
    it('should log info to Rollbar if enabled', () => {
      ...
      logger.info(logMessage)
      let rollbarCalledWithMessage = rollbarStub.info.withArgs(logMessage).called
  ...
  describe('#debug', () => {
    ...
    it('should log debug to Rollbar if enabled', () => {
      ...
      logger.debug(logMessage)
      let rollbarCalledWithMessage = rollbarStub.debug.withArgs(logMessage).called
      console.debug.restore()
      rollbarCalledWithMessage.should.be.true
    })
  })
  ...
  describe('#warn', () => {
    ...
    it('should log warning to Rollbar if enabled', () => {
      ...
      logger.warn(logMessage)
      let rollbarCalledWithMessage = rollbarStub.warn.withArgs(logMessage).called
      console.warn.restore()
      rollbarCalledWithMessage.should.be.true
    })
  })
  ...
  describe('#error', () => {
    ...
    it('should log error to Rollbar if enabled', () => {
      ...
      logger.error(logMessage)
      let rollbarCalledWithMessage = rollbarStub.error.withArgs(logMessage).called
      console.error.restore()
      rollbarCalledWithMessage.should.be.true
    })
  })
